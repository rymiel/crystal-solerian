module Solerian::Noun
  ...
  def self.class_name(type : Type, long = true) : String
    case type
  ...
  def self.determine_class_name(word : String) : String
    self.determine_class(word).try { |i| self.class_name(i, long: false) } || "?"
  end
end

module Solerian::Verb
  enum Type
    O
    I
    II
